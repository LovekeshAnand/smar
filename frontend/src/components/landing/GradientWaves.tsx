...
export const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    const initH = hexToRgb(horizonColor);
    const initW = hexToRgb(waveColor);
    const initC = hexToRgb(crestColor);
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uHorizonColor: { value: new Float32Array(initH) },
        uWaveColor: { value: new Float32Array(initW) },
        uCrestColor: { value: new Float32Array(initC) }
      }
    });
